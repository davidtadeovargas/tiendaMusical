    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-cart-plus"></i>                            </a>
                             <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="#">Ir a carrito</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#">Limpiar carrito</a>
                            </div>
                        </li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="charts.html" aria-expanded="false"><i class="fas fa-th-list"></i><span class="hide-menu">Catálogo</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="widgets.html" aria-expanded="false"><i class="fas fa-folder"></i><span class="hide-menu">Cotizaciones</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="tables.html" aria-expanded="false"><i class="fas fa-cart-plus"></i><span class="hide-menu">Carrito</span></a></li>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                All Rights Reserved by {{ config('app.name', 'Laravel') }}-admin.
                 Designed and Developed by <a href="#">The digital artifact</a>
            </footer>
        </div>
    </div>
