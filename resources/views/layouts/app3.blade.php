...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" style="" class=" js no-touch localstorage" lang="es">
...
<script>
    (function(h,o,t,j,a,r){
        ...
        h._hjSettings={hjid:416823,hjsv:5};
			...
			<div id="mini-cart-wrapper-regular">
				@if (count($cart))
 				<div id="mini-cart" class="mini-cart dropdown is-not-empty">
    				...
    				<div id="header-cart" class="mini-cart-content dropdown-content left-hand block block-cart skip-content skip-content--style" style="display: none;">
            			<div class="">
							<div class="block-subtitle">Agregados recientemente</div>
								@foreach($cart as $item)
                				<ol id="cart-sidebar" class="mini-products-list clearer">
                                    <li class="item last odd">
            							<a href="" title="" class="product-image">
            								<img src="{{asset('images/productos/'.$item->articulo.'.jpg')}}" alt="{{$item->nombre}}" width="50" height="50">
            							</a>
        								<div class="product-details">
        									<a href="" title="Remover Artículo" onclick="return confirm('Estas seguro de eliminarlo de tu carrito?');" class="btn-remove">Remover Artículo</a>
                							<a href="" title="Editar Artículo" class="btn-edit">Editar Artículo</a>
                							<p class="product-name">
                								<a href="">{{$item->nombre}}</a>
                							</p>
        									<strong>{{$item->quantity}}</strong> x
											<span class="price">${{ number_format($item->precio_u, 2)}}</span>                    
    									</div>
									</li>
                                </ol>
                                @endforeach
                                <script type="text/javascript">decorateList('cart-sidebar', 'none-recursive')
                            	</script>
                				<div class="subtotal">
                				...
                				<div class="actions clearer">
                    				<a href="{{route('cart-show')}}" title="Ver todos los artículos de tu pedido." class="button btn-inline">
                    					<span>
                    						<span style="background-color: #fdcd00;">Ver Todo</span>
                    					</span>
                    				</a>
                    
                                    <a href="{{route('order-detail')}}" title="REALIZAR COMPRA" class="button btn-checkout btn-inline">
                                    	<span>
                                    		<span style="background-color: #fdcd00;">REALIZAR COMPRA</span>
                                    	</span>
                                    </a>
                                </div>
            			</div>
...
<div id="account-links-wrapper-regular">
	<div id="header-account" class="top-links links-wrapper-separators-left skip-content skip-content--style">
		<ul class="links">
			@if (Auth::guest())
                <li class="first">
                	<a href="{{route('account-register')}}">Regístrate</a>
                </li>
                <li class="last">
                	<a href="{{route('account-login')}}">Iniciar Sesión</a>
                </li>
            @else
            	<li class="dropdown">
...
<li><a href="/politicas">Políticas de Envío, Devolución y Cancelación</a></li>
<li><a href="#">Tu Cuenta</a></li>
<li><a href="/forma-compra">¿Cómo comprar en {{ config('app.name', 'Laravel') }}?</a></li>
</ul>
</div>
</div></div></div>
...
<div class="block-content block-exct"><div class="grid block-exct">
    ...
    <form action="https://www.veerkamponline.com/newsletter/subscriber/new/" method="post" id="newsletter-validate-detail">
        <div>
            <div class="item">
                <input name="email" id="newsletter" title="Suscríbase a nuestras noticias" class="input-text required-entry validate-email" value="Ingresa tu email" type="text">
            </div>
            <div class="item">
	            <div class="btn-sbr">
			...
			<div class="inner-container">
				...
				<div class="clearer">
							...
							<div class="footer-copyright">
								<center>
									<img src="{{asset('images/icons-payments-certificados.png')}}">
								</center>
© 2016 Veerkamp Mesones S.A de C.V. Todos los Derechos Reservados <br> Sucursal Mesones 21, Col. Centro, Del. Cuauhtémoc, CDMX, CP 06080</div>
						</div>
